...
('Новый контракт с ОАО "МТЗ"', 'Заключен договор на поставку 500 двигателей в третьем квартале.', '2024-05-20', 3),
('Модернизация литейного цеха', 'Установлено новое оборудование для повышения качества отливок.', '2024-03-10', 4),
('Поздравление с Днем машиностроителя', 'Коллектив предприятия отмечен благодарностями за высокие показатели.', '2024-09-22', 2);

-- Оборудование (Инвентаризация)
INSERT INTO equipment (name, inventory_number, location, status, last_maintenance) VALUES
('Токарный станок 16К20', 'EQ-001', 'Механический цех', 'active', '2024-05-15'),
('Фрезерный станок 6Р12', 'EQ-002', 'Механический цех', 'active', '2024-04-20'),
('Плавильная печь ПЧ-1', 'EQ-003', 'Литейный цех', 'active', '2024-06-01'),
('Компрессор воздушный КВ-5', 'EQ-004', 'Компрессорная', 'repair', '2024-03-10'),
('Кран мостовой 5т', 'EQ-005', 'Сборочный цех', 'active', '2024-05-25'),
('Станок сверлильный 2Н135', 'EQ-006', 'Механический цех', 'active', '2024-04-15'),
('Пресс гидравлический П6320', 'EQ-007', 'Цех ТНП', 'decommissioned', '2023-12-01'),
('Вибрационный стол ВСТ-1', 'EQ-008', 'Цех ТНП', 'active', '2024-05-10'),
('Сушильная камера СЭК-2', 'EQ-009', 'Цех окраски', 'active', '2024-06-05'),
('Генератор дизельный АД-100', 'EQ-010', 'Энергоцех', 'active', '2024-05-30');
...
INSERT INTO orders (order_number, partner_id, user_id, status, total_amount_byn, created_at) VALUES
('ORD-2024-090', 5, 3, 'ready', 25000.00, '2024-06-01 10:30:00'),
('ORD-2024-091', 6, 7, 'processing', 8500.00, '2024-06-05 14:00:00'),
('ORD-2024-092', 8, 3, 'new', 15000.00, '2024-06-10 09:45:00'),
('ORD-2024-093', 5, 7, 'shipped', 32000.00, '2024-06-12 11:20:00'),
('ORD-2024-094', 9, 3, 'closed', 18500.00, '2024-06-15 16:00:00');

-- Товары в новые заказы
INSERT INTO order_items (order_id, product_id, quantity, price_at_moment_byn) VALUES
(2, 2, 20, 580.50),
(3, 3, 5, 920.00),
(5, 4, 10, 1250.00),
...
INSERT INTO production_tasks (task_number, product_id, quantity_plan, quantity_fact, workshop, status, deadline) VALUES
('TASK-24-052', 11, 100, 50, 'Сборочный цех №2', 'in_progress', '2024-06-20'),
('TASK-24-053', 12, 75, 0, 'Сборочный цех №1', 'planned', '2024-06-25'),
('TASK-24-054', 13, 60, 30, 'Спеццех', 'in_progress', '2024-06-18'),
('TASK-24-055', 14, 40, 0, 'Цех ТНП', 'planned', '2024-06-30'),
('TASK-24-056', 15, 200, 100, 'Цех ТНП', 'in_progress', '2024-06-22');
...
('2024-06-01 09:00:00', 'income', 'product', 1, 50, 4, 'Поступление со сборочного цеха'),
('2024-06-02 10:30:00', 'outcome', 'product', 2, 20, 4, 'Отгрузка по заказу ORD-2024-090'),
('2024-06-03 14:00:00', 'income', 'material', 1, 1000, 8, 'Поставка от ЗАО "Металлоторг"'),
('2024-06-05 11:15:00', 'write_off', 'material', 3, 15, 4, 'Списание брака'),
('2024-06-06 16:45:00', 'outcome', 'product', 6, 200, 4, 'Отгрузка в торговую сеть');
